import re
import sys
icg_file = "C:/Users/narus/Documents/Python Scripts/input.txt"
...
def remove_dead_code(list_of_lines) :
	"""
	Temporaries that are never assigned to any variable nor 
	used in any expression are deleted. Done recursively.
	"""
